...
# =============================================================================
# Main Model - CamouflageHerdNetConvNeXtV2
# =============================================================================

@MODELS.register()
class CamouflageHerdNetConvNeXtV2(nn.Module):
    """
    ...
    def __init__(
        ...
        if debug:
            logger.info(f"\nInitializing CamouflageHerdNetConvNeXtV2:")
    ...
    def forward(self, x: torch.Tensor, debug: bool = False) -> Tuple[torch.Tensor, torch.Tensor] | Dict:
        ...
        # During training, also return auxiliary heatmaps for deep supervision
        # Upsample aux outputs to match main heatmap resolution so the same loss target works
        if self.training:
...
def create_camouflage_herdnet_convnext(
...
) -> CamouflageHerdNetConvNeXtV2:
    """
    Create CamouflageHerdNetConvNeXtV2 model optimized for camouflaged objects.
    ...
    Returns:
        CamouflageHerdNetConvNeXtV2 model
    """
    model = CamouflageHerdNetConvNeXtV2(
