"""Phase 15 iteration 6 download (al_v8 held-out val: 14 non-Fern datasets / 8 islands)."""
...
OUTPUT_HASTY = HASTY_MASTER.parent / f"{HASTY_MASTER.stem}_phase15_iter6_corrected.json"
EDIT_LOG = Path("/home/christian/hnee/HerdNet/data/phase15_edit_log.csv")
ITERATION_ID = "phase15_iter6_al_v8"
